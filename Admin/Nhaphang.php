                        ...
                        <div class="panel panel-default">
                            <form method="post">
                                <div style="margin-top: 15px; margin-bottom: 10px; margin-left: 20px;">
                                    ...
                                    <input type="button" id="insertsp" value="Thêm sản phẩm">
                                    <script>
                                        $('#insertsp').click(function(){
                                            window.location = 'insertsp.php';
                                        });
                                    </script>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo$km = $sp["TysoGiamGia"]>0 ? "Có" : "Không"; ?></td>
                                                        <td><a href="updatesp.php?idsp=<?php echo$sp["ID_SP"]; ?>">cập nhật</a></td>
                                                    </tr>
                                                <?php
                                                    }
                                                ?>
