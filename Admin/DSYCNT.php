...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <h1 class="page-head-line">Danh sách đang chờ xác thực nạp tiền</h1>
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <form method="post">
                                <div class="panel-body">
                                    <div class="table-responsive" style="height: 1600px; overflow: auto;">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    $listycxt = $getdata->Load_YCXT();
                                                    $stt=1;
                                                    foreach($listycxt as $sp){
                                                ?>
                                                    <tr>
                                                        <td><?php echo$stt++; ?></td>
                                                        <td><?php echo$sp["Name_TK"]; ?></td>
                                                        <td><?php echo$sp["STK"]; ?></td>
                                                        <td><input type="number" value="<?php echo$sp["SoTien"]; ?>" disabled></td>
                                                        <td><a href="ChitietUser.php?TenTK=<?php echo$sp["Name_TK"]; ?>&st=<?php echo$sp["SoTien"]; ?>" onclick="<?php $_SESSION['Back'] = 'DSYCNT.php' ?>">Xác thực</a></td>
                                                    </tr>
                                                <?php
                                                    }
                                                ?>
