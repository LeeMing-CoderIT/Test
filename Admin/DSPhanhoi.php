...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <h1 class="page-head-line">Phản hồi</h1>
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="font-weight: bold;">Các phản hồi</div>
                            <div class="panel-body">
                                <div class="table-responsive" style="height: 500px; overflow: auto;">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                $select_sp = $getdata->Load_SP('ni_contact');
                                                $stt=1;
                                                foreach($select_sp as $sp){
                                            ?>
                                                <tr>
                                                    <td><?php echo$stt++; ?></td>
                                                    <td><?php echo$sp['Fullname']; ?></td>
                                                    <td><?php echo$sp['Email']; ?></td>
                                                    <td><?php echo$sp['Phone']; ?></td>
                                                    <td><?php echo$sp['Mess']; ?></td>
                                                    <td><a href="xoaph.php?del=<?php echo$sp['ID']; ?>" onclick="return(confirm('Bạn có chắc chắn muốn xóa phản hồi.');">
