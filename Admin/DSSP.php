...
<body>
    <div id="wrapper">
        ...
        <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
            <h1 class="page-head-line">Kho hàng</h1>
            <div id="page-inner" style="overflow: auto;">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="font-weight: bold;">Tất cả mặt hàng</div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive" style="height: 200px; overflow-y: scroll; margin-top: -22px;">
                                    <table class="table table-striped table-bordered table-hover"  style="width: 1000px;">
                                        <tbody>
                                            <?php
                                                $select_sp = $getdata->Load_SP('dssp');
                                                $stt=1;
                                                foreach($select_sp as $sp){
                                            ?>
                                                <tr>
                                                    <td style="width: 5%;"><?php echo$stt++; ?></td>
                                                    <td style="width: 15%;"><?php echo$sp['ID_SP']; ?></td>
                                                    <td style="width: 25%;"><?php echo$sp['Name_SP']; ?></td>
                                                    <td style="width: 10%;"><?php echo$sp["Price"]; ?>$</td>
                                                    <td style="width: 15%;"><?php echo$sp["SLConLai"]; ?></td>
                                                    <td style="width: 15%;"><a href="updatevc.php?idvc=<?php echo$sp["ID_SP"]; ?>"><?php echo$km = $sp["TysoGiamGia"]>0 ? "Có" : "Không"; ?></a></td>
                                                    <td style="width: 15%;"><a href="deletesp.php?idsp=<?php echo$sp["ID_SP"]; ?>" style="color: red;" 
                                                    onclick="return(confirm('Bạn có chắc chắn muốn loại bỏ?'));">Loại bỏ sản phẩm</a></td>
                                                </tr>
                                            <?php
                                                }
                                            ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="font-weight: bold;">Các mặt hàng đang giảm giá</div>
                            <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo$sp['Name_SP']; ?></td>
                                                        <td><?php echo'<span style="text-decoration: line-through; font-size: 12px;">'.$sp['Price']
                                                                    .'$<br></span><span style="color: orangered;">'.($sp['Price']-$sp['Price']
                                                                    *$sp['TysoGiamGia']/100)."$</sapn>"; ?></td>
                                                        <td><?php echo$sp['SLConLai']; ?></td>
                                                        <td><?php echo$sp['SLUuDai']; ?></td>
                                                        </tr>
                                            <?php
                                                    }
                                                }
