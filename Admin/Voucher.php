...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <h1 class="page-head-line">Khuyến mãi</h1>
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <form method="post">
                                <div style="margin-top: 15px; margin-bottom: 10px; margin-left: 20px;">
                                    ...
                                    <!-- <input type="button" id="insertvc" value="Thêm voucher">
                                    <script>
                                        $('#insertvc').click(function(){
                                            window.location = 'insertvc.php';
                                        });
                                    </script> -->
                                </div>
                                <div class="panel-heading" style="font-weight: bold;">Danh sách sản phẩm giảm giá</div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo$sp["TysoGiamGia"]; ?>%</td>
                                                        <td><a href="updatevc.php?idvc=<?php echo$sp["ID_SP"]; ?>">cập nhật</a></td>
                                                    </tr>
                                                <?php
                                                        }
                                                    }
