            ...
            <form method="post">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    <input type="text" name="txtMess" class="message_input" placeholder="Lời nhắn" />
                  </div>
                  <div>
                    <button type="submit" name="oke">Gửi</button>
                  </div>
                </div>
              </div>
              <?php
                if(isset($_POST['oke'])){
                  if(empty($_POST['txtEmail']) || empty($_POST['txtMess'])){
                    echo'<script>alert("Bạn chưa nhập đủ thông tin để phan hồi.");</script>';
                  }
                  else{
                    $phanhoi = $getdata->Phanhoi( $_POST['txtfullname'],
                                                  $_POST['txtEmail'],
                                                  $_POST['txtSdt'],
                                                  $_POST['txtMess']);
                    if($phanhoi){
                      echo'<script>alert("Cảm ơn bạn '.$_POST['txtfullname'].' đã đóng góp ý kiến. Chúng tôi sẽ liên hệ với bạn");</script>';
                    }else{
                      echo'<script>alert("Chú ý phản hồi thất bại. Bạn hãy thử lại.");</script>';
                    }
                  }
                }
              ?>
            ...
            <div class="map_container">
              <div class="map-responsive">
                <iframe id="diachi"
                  ...
                  width="600" height="300" frameborder="1" style="border:1; width: 100%; height:100%"
                  allowfullscreen>
                </iframe>
              </div>
            </div>
